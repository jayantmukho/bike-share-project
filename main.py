...
x1= np.loadtxt(data_file, skiprows=1, dtype=np.float64, usecols=(1,2,3,4,5,6,7), delimiter=',')
...
with open('full_params.csv', 'w') as f:
    writer = csv.writer(f)
    writer.writerows(x)
    

np.savetxt("y_vector.csv", y, delimiter=',', header="duration")
